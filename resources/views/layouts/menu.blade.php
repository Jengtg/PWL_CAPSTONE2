...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="{{ url('/') }}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Capstone2</span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        @auth
            ...
            @if(auth()->user()->role == 'panitia_kegiatan')
                ...
                {{-- THIS IS THE CONSOLIDATED AND CORRECTED MENU ITEM --}}
                <li class="menu-item {{ request()->routeIs(['committee.attendance.*', 'committee.certificates.*']) ? 'active' : '' }}">
                    <a href="{{ route('committee.attendance.index') }}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-qr-scan"></i>
                        <div data-i18n="Kelola Sesi">Kelola Sesi</div>
                    </a>
                </li>
            @endif
